...
from task_manager.views import index, TasksView, TaskDetailView, TaskCreateView, CommentaryCreateView, \
    TaskUpdateView, task_done, team, MyTasksView, TaskDeleteView
